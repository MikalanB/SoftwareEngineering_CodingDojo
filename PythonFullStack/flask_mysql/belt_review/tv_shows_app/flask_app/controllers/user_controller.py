...
def dashboard():
    ...
    user_shows = Show.shows_by_user_id(data)
    shows_liked = Show.show_likes()
    return render_template('dashboard.html', user_shows=user_shows, user=user, all_shows = all_shows, shows_liked=shows_liked)
